...
export const videosData: Video[] = [
  {
    ...
    isFeatured: true,
    learningOutcomes: [
      'Understand the core concepts of Complex Number Questions & Solutions',
    ...
    nextVideoId: 'neb-class-12-math-complex-numbers-intro',
  ...
  },
  {
    ...
    isFeatured: true,
    learningOutcomes: [
      'Understand the core concepts of Introduction to Complex Numbers',
      'Solve important NEB board questions',
      'Apply formulas effectively'
    ],
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-vector-product-2',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  },
  {
    ...
    isFeatured: true,
    learningOutcomes: [
      'Understand the core concepts of Vector Product Questions Part 2',
      'Solve important NEB board questions',
      'Apply formulas effectively'
    ],
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-vector-product-1',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  },
  {
    ...
    isFeatured: false,
    learningOutcomes: [
      'Understand the core concepts of Vector Product of Vectors Problem Solving',
      'Solve important NEB board questions',
      'Apply formulas effectively'
    ],
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-cross-product',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  },
  {
    ...
    isFeatured: false,
    learningOutcomes: [
      'Understand the core concepts of Vector Product of Vectors',
      'Solve important NEB board questions',
      'Apply formulas effectively'
    ],
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-properties-triangle-2',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  },
  {
    ...
    isFeatured: false,
    learningOutcomes: [
      'Understand the core concepts of Properties of Triangle Questions',
      'Solve important NEB board questions',
      'Apply formulas effectively'
    ],
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-properties-triangle-1',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  },
  {
    ...
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-scalar-product-trig',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  },
  {
    ...
    isFeatured: false,
    learningOutcomes: [
      'Understand the core concepts of Scalar Product',
      'Solve important NEB board questions',
      'Apply formulas effectively'
    ],
    targetAudience: 'Nepali +2 Class 12 Science students.',
    prerequisites: ['Basic Algebra', 'Trigonometry'],
    nextVideoId: 'neb-class-12-math-complex-numbers-1',
    channelName: 'Gravicos',
    channelUrl: 'https://www.youtube.com/@gravicos'
  }
]
